...
python evaluate_detection_models_tf1.py --device=CPU --env=venv --model_type=Classification

: TF 1.14
call venvs\tf14_cfs\Scripts\activate
python evaluate_detection_models_tf1.py --device=CPU --env=venv --avx --model_type=Classification
...
python evaluate_detection_models_tf2.py --device=CPU --env=venv --model_type=Classification

: TF 2.0
call venvs\tf20_cfs\Scripts\activate
python evaluate_detection_models_tf2.py --device=CPU --env=venv --avx --model_type=Classification
...
python evaluate_detection_models_tf2.py --device=GPU --env=venv --avx --model_type=Classification
